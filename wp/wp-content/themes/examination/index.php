...
<section class="banner">
      <div class="wrapper container">
        <div class="content">
          <div class="text">
            <p>Does Your Home or Property Have </p><span class="yellow">Storm Damage </span><span>or </span><span class="yellow">Need an Update </span><span>?</span>
          </div><a class="btn">Contact Us Today</a>
        </div>
      </div>
    </section>
    <div class="page">
      ...
      <section class="services">
        ...
        <div class="wrapper container">
          <div class="services__item"><a class="avatar"><img src="./img/siding.png"/></a>
          ...
          <div class="services__item"><a class="avatar"><img src="./img/paint.png"/></a>
            <div class="services__item-textblock">
          ...
          <div class="services__item"><a class="avatar" href="./windows.html"><img src="./img/siding.png"/></a>
            <div class="services__item-textblock">
      ...
      <section class="works">
        ...
        <div class="wrapper container">
          <div class="works__item">
            <div class="works__item-avatar"><img src="./img/service1.png"/></div>
            <div class="works__item-link">
              <p>Residential Repair</p>
            </div>
          </div>
          <div class="works__item">
            <div class="works__item-avatar"><img src="./img/service2.png"/></div>
            <div class="works__item-link">
              <p>Commercial Repair</p>
            </div>
          </div>
          <div class="works__item">
            <div class="works__item-avatar"><img src="./img/service3.png"/></div>
            <div class="works__item-link">
      ...
      <section class="news">
        ...
        <div class="wrapper container">
          <div class="news__item">
            ...
            <div class="avatar"><img src="./img/news.png"/></div>
      ...
      <section class="contact-block">
        <div class="wrapper container">
          ...
          <div class="gallery">
            ...
            <div class="box">
              <div class="gallery__item"><img src="./img/house.png"/></div>
              <div class="gallery__item"><img src="./img/house.png"/></div>
              <div class="gallery__item"><img src="./img/house.png"/></div>
              <div class="gallery__item"><img src="./img/house.png"/></div>
              <div class="gallery__item"><img src="./img/house.png"/></div>
              <div class="gallery__item"><img src="./img/house.png"/></div>
              <div class="gallery__item"><img src="./img/house.png"/></div>
              <div class="gallery__item"><img src="./img/house.png"/></div><a class="footer-btn">View More Photos</a>
            </div>
          </div>
        </div>
      </section>
